...
function CategorySideBar() {
    ...
    // getting the category from url path
    ...
    <div>
        ...
        <div >
            {categoryList.map((category,index)=>(
                <Link href={'/search/'+category.name} key={index} className={`flex gap-2 p-3 border rounded-lg mb-3 mr-10 cursor-pointer 
                hover:bg-purple-50 hover:text-primary
                items-center hover:shadow-md hover:border-primary
